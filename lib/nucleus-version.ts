 ...
 */
export const NUCLEUS_VERSION = '3.0.0' as const;

/** major.minor for badges and marketing (e.g. "3.0") */
export const NUCLEUS_LINE = NUCLEUS_VERSION.split('.').slice(0, 2).join('.') as '3.0';
