---
title: Roadmap
description: What shipped in Nucleus 2.0–2.3, the modules planned next, and features under consideration.
---
...
Security and identity modules (still planned; not part of the 2.3.0 release):
