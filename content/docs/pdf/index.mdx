...
The PDF reader ships from its own repository with its own release cycle, like the [system tray](/docs/os/system-tray). The artifact is `dev.nucleusframework:pdfium`, published to Maven Central.
</Callout>
