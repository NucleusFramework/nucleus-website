...
- `val toolchain: GraalvmToolchainSettings`:
  ...
  - `channel: Property<GraalvmChannel> = INNOVATION` — `INNOVATION` (defaults to `25i2` / GraalVM 25.2 from 2.3) / `LTS`
  - `version: Property<String>` — overrides `channel` (`"25i2"`, `"25"`, `"25.0.1"`, …)
