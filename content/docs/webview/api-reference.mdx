...
- `content` is Compose UI drawn **over** the native surface (`NativeView` content slot on desktop; a layered sibling elsewhere).
...
- [WebView overview](/docs/webview) — supported targets and platform engines.
