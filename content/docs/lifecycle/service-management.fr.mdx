...
3. **Active depuis le UI** — macOS ne fera pas tourner le plist embarqué tant que le app ne l'enregistre pas explicitement (et que l'utilisateur n'a pas approuvé) :
