...
Win32, GTK4, …), écris ce côté-là en Kotlin/Native et laisse [NucleusNativeAccess](/docs/performance/native-code)
générer le bridge FFM, les proxies JVM et la metadata GraalVM pour toi. Les `reflect-config.json`,
