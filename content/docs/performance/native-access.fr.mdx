...
- Résultat : `./gradlew packageGraalvmNative` produit un binaire qui marche sans qu'on écrive une ligne de metadata.
...
Si on dépend de l'un d'eux, livre plutôt le [build AOT cache](/docs/performance/aot-cache). Pour tout le reste — Compose, ktor, kotlinx.serialization, Coil, SQLite, Jewel, SLF4J, Kotlin idiomatique — Nucleus gère.
