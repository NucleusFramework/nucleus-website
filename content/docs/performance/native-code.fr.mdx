...
L'accès natif est livré depuis [`NucleusFramework/NucleusNativeAccess`](https://github.com/NucleusFramework/NucleusNativeAccess) avec son propre cycle de release, comme le [system tray](/docs/os/system-tray), le [lecteur PDF](/docs/pdf) et la [WebView](/docs/webview). C'est un plugin Gradle, `dev.nucleusframework.nna`, versionné indépendamment de Nucleus et sous licence MIT.
<Version module="nna" />
</Callout>
...
- [Chargeur de bibliothèques natives](/docs/performance/native-library-loader) — comment les modules Nucleus chargent leurs propres libs JNI (distinct du cache `kne/` de ce plugin).
...
- [WebView](/docs/webview) — une seule API WebView sur Android, iOS, web et desktop.
