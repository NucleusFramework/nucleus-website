...
| Tâche | Description |
|-------|-------------|
| `packageGraalvmNative` | Assembleur interne : compile l'image et pose le dossier d'app (binaire + libs Skiko/AWT + icônes). Préférez les tâches publiques ci-dessus. |
