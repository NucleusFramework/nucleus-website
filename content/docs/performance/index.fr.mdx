---
title: Choisis ton compromis. Gagne dans tous les cas.
...
- Un seul DSL Gradle pilote les deux. Tu changes un flag, tu livres un autre artefact.
- Les métadonnées de réflexion, JNI et ressources sont injectées automatiquement pour chaque module Nucleus — tu n'écris jamais de `reflect-config.json` à la main.
...
- [Accès natif](/docs/performance/native-access) — comment Nucleus résout les métadonnées GraalVM (réflexion / ressources / JNI) pour que tu n'écrives pas de JSON.
