...
- Un seul DSL Gradle pilote les deux. Tu changes un flag, on livres un autre artefact.
...
- [Accès natif](/docs/performance/native-access) — comment Nucleus résout les métadonnées GraalVM (réflexion / ressources / JNI) pour que on n'écrives pas de JSON.
