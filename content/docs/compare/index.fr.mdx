...
| RAM au repos | 30–120 MB* | 200–500 MB | 50–80 MB | 200 MB |
...
| Compose (JVM) | JDK 21 + AWT | — | ~0,70 s | ~174 MB | 1 |
...
- **Nucleus se situe dans la même classe des ~30 MB qu'un WinUI 3 natif** — tout en restant
  100 % Kotlin/Compose — et utilise environ un tiers de la mémoire de Tauri et un sixième de
  celle du build JVM classique. C'est le natif/AOT qui procure à la fois la RAM basse et le
  démarrage sous 0,2 s.
...
<Callout type="info">
Dans le tableau de comparaison, les chiffres d'Electron et de Tauri proviennent de benchmarks
publics. Les chiffres Nucleus, WinUI 3, Tauri et JVM de la section **Mesuré** ci-dessus ont
été relevés de première main sur une seule machine Windows 11, en runs à chaud sauf mention
contraire.
