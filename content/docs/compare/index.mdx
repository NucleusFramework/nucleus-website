...
| RAM idle | 30–120 MB* | 200–500 MB | 50–80 MB | 200 MB |
...
- **Nucleus lands in the same ~30 MB class as native WinUI 3** — while staying pure
  Kotlin/Compose — and uses roughly a third of Tauri's memory and a sixth of the plain-JVM
  build's. Native/AOT is what buys both the low RAM and the sub-0.2 s start.
...
<Callout type="info">
In the comparison table, the Electron and Tauri figures are drawn from public benchmarks. The
Nucleus, WinUI 3, Tauri, and JVM numbers in the **Measured** section above were collected
first-hand on a single Windows 11 machine, warm runs unless noted.
