...
## Ce que on obtiens concrètement
...
- [Architecture](/docs/concepts/architecture) — le modèle en couches : le app → Nucleus → Compose Multiplatform → KMP → JDK/GraalVM.
