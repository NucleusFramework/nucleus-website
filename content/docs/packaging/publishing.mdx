...
S3, your own copy step for generic). See [release CI](/docs/packaging/ci-cd#publish-the-release) for the standard
path.
</Callout>
...
- **Microsoft Store** — upload the `.msixbundle` to [Partner Center](https://partner.microsoft.com/).
  ...
  `publisherDisplayName`). See [Windows targets](/docs/packaging/windows#build-an-appx-or-msix-package).
