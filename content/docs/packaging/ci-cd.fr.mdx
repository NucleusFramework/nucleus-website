...
Construire, signer et publier sur trois OS et quatre architectures à la main, c'est un job à temps plein. Nucleus livre six actions composites GitHub Actions qui gèrent toute la pipeline — et un workflow de release de référence qu'on peut `uses:` directement depuis le repo Nucleus, sans copier-coller.
