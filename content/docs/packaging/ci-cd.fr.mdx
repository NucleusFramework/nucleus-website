...
épinglez un tag comme `@v2.5.0` pour la production.
</Callout>
...
| `graalvm-version` | `25i2` | Version de la toolchain — composant de clé de cache uniquement. À garder synchronisé avec `graalvm { toolchain { } }`. |
