...
- Chaque hôte de fenêtre Windows possède un contexte ANGLE GLES non partagé. Les purges du
  cache GPU sur le chemin de resize lient d'abord ce contexte pour que les textures d'une
  fenêtre sœur restent intactes. Les surfaces popup / tray macOS et Linux peuvent aussi
  posséder des contextes privés.
