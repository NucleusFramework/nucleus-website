...
- **GitHub Releases** — le [workflow de release](/docs/packaging/ci-cd#publier-la-release) gère tout de bout en bout.
...
Ça s'appuie sur la [signature Linux](/docs/packaging/code-signing#signer-sur-linux).
...
- [CI/CD](/docs/packaging/ci-cd#publier-la-release) — le workflow de release qui génère et uploade les métadonnées.
