...
One common desktop need has no Nucleus module, because an existing library already covers it:
...
- [Spell check](/docs/os/spell-check) — the system spell checker, with Compose context-menu integration.
