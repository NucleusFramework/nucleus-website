...
| Tray-anchored popup apps | `composenativetray-app` | yes | yes | yes |
...
the same group, without the `nucleus.` prefix. From 2.1.0, `composenativetray` is the icon and
menu; `composenativetray-app` is `TrayApp` and depends on the Tao window backend.
