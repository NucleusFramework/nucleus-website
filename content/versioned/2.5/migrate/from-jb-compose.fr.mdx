...
<Callout title="Vous préférez ne pas le faire à la main ?">
Un agent IA peut exécuter toute cette migration pour vous — y compris la migration du shell de
fenêtre et le retrait d'AWT que ce guide, centré sur le build, ne couvre pas. Un prompt, zéro
installation : [Migrer avec un agent IA](/docs/migrate/ai-agent).
</Callout>
...
| Apparence DMG | Non personnalisable | DSL `dmg { }` complet ([détails](/docs/packaging/macos#empaqueter-un-dmg)) |
