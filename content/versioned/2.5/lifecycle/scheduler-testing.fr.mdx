...
[scheduler](/docs/lifecycle/scheduler), afin d'exercer vos tâches d'arrière-plan dans des tests
...
- [Scheduler](/docs/lifecycle/scheduler) — enregistrez des tâches, construisez des requêtes, et configurez contraintes et tentatives.
